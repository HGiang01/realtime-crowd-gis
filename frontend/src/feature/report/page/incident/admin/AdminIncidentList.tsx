            ...
            >
                {reports.map((report) => (
                    <ReportCard
                        ...
                        actionLink={`/admin/incident-reports/${report.id}/review`}
                    />
                ))}
            </div>
        );
                ...
                <div className="relative min-h-100 mt-2">
                    {isLoading ? (
                        ...
                        <div className="flex-1 py-20 flex flex-col justify-center items-center text-center text-on-wg-surface-variant">
                            ...
                            <p className="text-sm">
                                You haven't claimed any incident reports yet. <br />
                                Claim your first incident report to get started.
                            </p>
                            <Link
                                to="/admin/incident-reports/pending"
                                className="mt-4 btn-primary-solid"
                            >
                                Claim new incident report
                            </Link>
                        </div>
                    )}
                </div>
