...
import { ArrowLeft, HelpCircle, ShieldAlert, MapPinned } from "lucide-react";
            ...
            <main className="flex-1 relative z-10 w-full max-w-6xl mx-auto flex items-center justify-center gap-12 px-8 pb-14 pt-10">
                ...
                >
                    <div className="mb-6 flex flex-col items-center justify-center gap-4">
                        <div className="flex h-16 w-16 items-center justify-center rounded-2xl bg-wg-warning/20 text-orange-400">
