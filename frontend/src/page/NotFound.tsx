...
import { ArrowLeft, HelpCircle, SearchAlert, MapPinned } from "lucide-react";
            ...
            <main className="flex-1 relative z-10 w-full max-w-6xl mx-auto flex items-center justify-center gap-12 px-8 pb-14 pt-10">
                ...
                >
                    <div className="mb-6 flex flex-col items-center justify-center gap-4">
                        <div className="flex h-16 w-16 items-center justify-center rounded-2xl bg-wg-error/20 text-wg-error">
                            <SearchAlert className="h-6 w-6" />
                        </div>
                    ...
                    <Link to="/home">
                        <button
                            className="inline-flex w-full items-center justify-center gap-2 rounded-2xl bg-wg-primary px-4 py-3 text-sm font-semibold text-on-wg-primary transition hover:bg-wg-primary-container cursor-pointer"
                            type="button"
                        >
